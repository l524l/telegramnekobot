...
@BotCommand
public class NsfwOff extends Command {

    private final TelegramSender telegramSender;
    private final UserRepository repository;
    private final KeyboardTemplate template;

    public NsfwOff(TelegramSender telegramSender, UserRepository repository, KeyboardTemplatesStore templatesStore) {
        this.telegramSender = telegramSender;
        this.repository = repository;
        this.template = templatesStore.getTemplate("nsfw_off");
    }
    ...
    public void execute() throws Exception {
        ...
        user.getUserSettings().setNSFW(false);
