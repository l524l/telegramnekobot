...
@BotCommand
public class PictureNSFW extends InlineCommand {
    ...
    public PictureNSFW(NekosApi nekosApi, KeyboardTemplatesStore templatesStore, BotSettings settings, TelegramSender telegramSender) {
    ...
    public void execute() {
        ...
        nekosApi.getNekoCategoryList().forEach((x)->{
            if(x.isNsfw()) {
                ...
                String thumb = settings.getBotPath() + "/adult.png";
